<!DOCTYPE HTML>
<!--
	guarida animal by HTML5 UP
	html5up.net | @ajlkn
	Free for personal and commercial use under the CCA 3.0 license (html5up.net/license)
-->
<html>
	<head>
		<title>Guarida animal by HTML5 UP</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<div id="header">
				<span class="image main"><img src="images/logo.jpg" alt="" width= "250px"></span>
				<h1>Bienvenidos a la guarida animal .</h1>
		...
		<!-- Footer -->
			<div id="footer">
				<div class="container medium">
					...
					<p> Llena este formulario con tus datos personales y tambien podes hablarnos a nuestras distintas redes sociales.</p>
